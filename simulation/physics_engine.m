classdef physics_engine < sim_component
    ...
    methods
        ...
        function oFcnHandle = engine(obj)
            oFcnHandle = @(t,x) kin_dyn_superposition(t, x, ...
                obj.pOwningSimHandle.params.physical.m, ...
                obj.pOwningSimHandle.params.physical.J, ...
                obj.pOwningSimHandle.controller.actuators.actuate(), ...
                obj.pForceTorqFcns, {{}}, obj.pKinDynFcns, {{}});
        end
    end
end
