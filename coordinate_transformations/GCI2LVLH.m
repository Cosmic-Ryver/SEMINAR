function [ T ] = GCI2LVLH( r, v )
% GCI2LVLH compute the CTM for the transformation from the GCI frame to the
%   LVLH frame
%
...
% INPUTS:
%
%   r = [3 x 1] {column vector, numeric} position in GCI frame.
%
%   v = [3 x 1] {column vector, numeric} velocity in the GCI frame.
%
% OUTPUTS:
%
%   T = [3 x 3] {array, numeric} coordinate transformation matrix for the
%       transformation from the Geocentric Inertial frame to the Local-
